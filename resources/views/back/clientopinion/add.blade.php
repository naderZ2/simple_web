            ...
            <form role="form" action="{{ route('clients.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="page_address_en" placeholder="Address">
                </div>
                
                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">تليفون</label>
                  <input type="text" class="form-control" name="page_phone" placeholder="تليفون">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">العنوان</label>
                  <input type="text" class="form-control" name="page_email" placeholder="البريد الالكترونى">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Address</label>
                  <input type="text" class="form-control" name="page_website" placeholder="الموقع الالكترونى">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Facebook</label>
                  <input type="text" class="form-control" name="page_facebook" placeholder="Facebook">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Twitter</label>
                  <input type="text" class="form-control" name="page_twitter" placeholder="Twitter" >
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Google</label>
                  <input type="text" class="form-control" name="page_google" placeholder="Google">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Instagram</label>
                  <input type="text" class="form-control" name="page_instagram" placeholder="Instagram">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Whatsapp</label>
                  <input type="text" class="form-control" name="page_whatsapp" placeholder="Whatsapp">
                </div>

                <div class="form-group col-md-6">
                  <label for="exampleInputEmail1">Youtube</label>
                  <input type="text" class="form-control" name="page_youtube" placeholder="Youtube">
                </div>
