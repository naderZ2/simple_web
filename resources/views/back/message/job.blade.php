            ...
            <div class="box-body">
              <table id="example1" class="table direction table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: 15%">البريد الالكترونى</th>
                  <th style="width: 15%">السيرة الذاتية</th>
				...
				<tr>
                  ...
                  <td>{{ $result_page->email }}</td>
                  <td><a href="{{url('public/uploads/cv/'.$result_page->cv)}}" target="_blank">السيرة الذاتية</a></td>
                  <td>
                  ...
                  <form id="delete-form-{{$result_page->id}}" method="post" action="{{ route('jobcv.destroy',$result_page->id) }}">
                  @method('DELETE')
                  @csrf
                  </form>
                  </td>
