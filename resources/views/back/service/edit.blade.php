      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('products.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="page_servicedept_id" id="page_servicedept_id">
                    @foreach($result_depts as $result_dept)
                    <option value="{{$result_dept->id}}" @if($result_dept->id == $result_page->servicedept_id) selected @endif>{{$result_dept->name}}</option>
                    @endforeach
                  </select>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <img src="{{url('public/uploads/products/'.$result_page->picture)}}" style="width: 100px; height: 100px;">
                  @endif
                  <br>
